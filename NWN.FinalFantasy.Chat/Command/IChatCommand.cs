...
namespace NWN.FinalFantasy.Chat.Command
{
    public interface IChatCommand
    {
        ...
        void DoAction(NWGameObject user, NWGameObject target, Location targetLocation, params string[] args);
        ...
        /// 
        /// <returns></returns>
        string ValidateArguments(NWGameObject user, params string[] args);
    }
}