...
using NWN.FinalFantasy.Core.Messaging.Contracts;
...
namespace NWN.FinalFantasy.Core.Messaging
{
    ...
    public sealed class MessageHub : IMessageHub
    {
        ...
        internal bool IsSubscribed(Guid token) => _subscriptions.IsRegistered(token);
        ...
        /// </summary>
        internal void ClearSubscriptions() => _subscriptions.Clear(false);
