...
namespace NWN.FinalFantasy.Tool.ModulePacker
{
    class Program
    {
        ...
        private static void PackModule()
        {
            ...
            RunProcess($"nwn_erf -e MOD -c \"./packing/\" -f \"Final Fantasy Online.mod\"");
        ...
        private static void UnpackModule()
        {
            ...
            RunProcess("nwn_erf -f \"Final Fantasy Online.mod\" -x");
