...
using Feat = NWN.FinalFantasy.Core.NWScript.Enum.Item.Property.Feat;
using RacialType = NWN.FinalFantasy.Core.NWScript.Enum.Item.Property.RacialType;
using SpellSchool = NWN.FinalFantasy.Core.NWScript.Enum.SpellSchool;
